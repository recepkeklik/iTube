...
const Main = () => {
  return (
    <div style={{backgroundImage:"linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(images/movie-application-bg.jpg)"}} className="w-full h-screen flex justify-center items-start font-Inter pb-[1080px]">
